  ...
  fields: [
    {
      name: "platform",
      type: "enum" as const,
      options: ["facebook", "instagram", "youtube", "dribbble", "x"],
      default: "instagram",
    },
    { name: "url", type: "string" as const },
  ],
...
const creatorModel = {
  ...
  fields: [
    ...
    { name: "image", type: "image" as const },
    { name: "imageHover", type: "image" as const },
    {
      name: "links",
      type: "list" as const,
      items: { type: "model" as const, models: ["creatorSocialLink"] },
    },
  ],
};
...
const creatorsGridSection = {
  ...
  fields: [
    ...
    { name: "titleAccent", type: "string" as const },
    { name: "subtitle", type: "text" as const },
    { name: "creators", type: "list" as const, items: { type: "model" as const, models: ["creator"] } },
  ],
};
