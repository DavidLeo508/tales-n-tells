        ...
        <div className="flex flex-col gap-16">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-2xl bg-gradient-to-br from-accent/20 to-accent/5 border border-accent/30 p-12 rounded-lg flex flex-col items-center justify-center text-center min-h-96">
              ...
              <p
                data-sb-field-path=".digitalBody"
                className="text-bone/60 text-lg mb-10 max-w-sm leading-relaxed"
              >
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 ${light ? "gap-1" : "gap-12"}`} data-sb-field-path=".items">
          {items.map((item, i) => (
            <div
              ...
              className={
                light
                  ? "border border-ink/10 p-12 hover:bg-ink hover:text-bone transition-all duration-500 group"
                  : "space-y-6"
              }
            >
  ...
  return (
    <section className="pt-24 pb-20 px-6 relative">
      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          <h2
            data-sb-field-path=".rolesTitle"
            className="text-3xl md:text-5xl font-black italic tracking-tighter uppercase mb-12"
          >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p
                      ...
                      className="text-bone/40 text-sm"
                    >
                      {role.description}
                    </p>
                  </div>
