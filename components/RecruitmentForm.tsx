    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          ...
          <input type="text" name="firstName" required className={FIELD} placeholder="Your first name" />
        </div>
        <div>
          <label className={LABEL}>Last Name</label>
          <input type="text" name="lastName" required className={FIELD} placeholder="Your last name" />
        </div>
      </div>
